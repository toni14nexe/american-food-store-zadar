      ...
      <template v-else>
        <ElRow justify="center" align="middle">
          <ElCard class="order-state-card">
            ...
            <ElRow>{{ appConfig.title }}</ElRow>
            <ElRow v-if="appConfig.companyData.email"
              >Email: appConfig.companyData.email</ElRow
            >
            <ElRow v-if="appConfig.companyData.telephone"
              >Mobitel: {{ appConfig.companyData.telephone }}</ElRow
            >
            <ElRow v-if="appConfig.companyData.addressLine1"
              >Adresa:
              {{ appConfig.companyData.addressLine1 }}
              {{
                appConfig.companyData.addressLine2
                  ? appConfig.companyData.addressLine2
                  : ''
              }}
              {{
                appConfig.companyData.addressLine3
                  ? appConfig.companyData.addressLine3
                  : ''
              }}
              {{
                appConfig.companyData.addressLine4
                  ? appConfig.companyData.addressLine4
                  : ''
              }}
            </ElRow>
            <ElRow class="mb-12"
              >Država: {{ appConfig.companyData.country }}</ElRow
            >
