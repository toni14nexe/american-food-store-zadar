...
export default defineEventHandler(async event => {
  ...
  const mailOptions = {
    ...
    html: `
           <a href="${url}" style="text-decoration: none"><h1 style="background-color: ${appConfig.mainColor}; color: white; width: fit-content; padding: 0 15px 0 14px; border-radius: 4px">${appConfig.title}</h1></a>
           <p>Bok ${user.firstname} ${user.lastname},</p>
           <p>Hvala na registraciji u ${appConfig.title}. Molimo vas potvrdite email otvaranjem linka:</p>
